...
The root-mean-square-error (rmse) of Model 1 (rmse = `r rmse_df_table$mean_rmse_mdl1`) is sloghtly smaller than that of Model 2 (rmse = `r rmse_df_table$mean_rmse_mdl2`), making Model 1 the model of best fit following this assessment. (Data: CalCOFI 2021)
